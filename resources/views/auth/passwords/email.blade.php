...
<head>
    ...
    .layout-login-centered-boxed__form{
        ...
        min-width: calc(280px + 10rem * 2) !important;
    }
    ...
    <div class="layout-login-centered-boxed__form">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-2 navbar-light">
            <a href="index.html" class="navbar-brand text-center mb-2 mr-0" style="min-width: 0">
                ...
                <span class="ml-2">Learning CMS</span>
            </a>
        </div>
        <div class="card">
        ...
        <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row mb-3">
                            <label for="identity_number" class="col-md-4 col-form-label text-md-end">Idenetification Number</label>
