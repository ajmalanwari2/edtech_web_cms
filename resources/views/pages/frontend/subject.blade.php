    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 vid_subject">
                ...
                <br><br>
                <div id="video-not-available" style="display:none">
                    <p>Learning video for this lesson is not available</p>
                </div>
...
function getYouTubeVideoId(url) {
    ...
    var regExp =
        /^(?:https?:\/\/)?(?:www\.)?(?:youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=|attribution_link\?.+watch\?v=)|youtu\.be\/)([^\s&?\/]+)/;
