            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                        <div class="flex">
                            <div class="card-subtitle text-muted">List of Registered Teachers</div>
                        </div>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-form">Register New teacher</button>
...
<script type="text/javascript">
    ...
    var url =site_url+'api/teacher/save';
    var data = {
        '_token': '{{ csrf_token() }}',
        name: $('#name').val(),
        email: $('#email').val(),
    ...
    if (!(id === undefined)) {
        url =site_url+'api/teacher/update';
        data.id = id;
    }
    $.ajax({
        type: "POST",
    ...
    function loadRecord(id) {
        $.ajax({
            ...
            success: (function(data) {
                ...
                $("#saveBTN").html("Update");
                $("#modal-form-title").html("teacher Update Form");
    ...
    function deleteRecord() {
        ...
        $.ajax({
            type: "POST",
            url: site_url + 'api/teacher/delete',
            data: {
                id: deleteRecordID,
                '_token': '{{ csrf_token() }}'
            },
    ...
    $(document).on('hide.bs.modal', '#modal-form', function() {
        ...
        $("#saveBTN").html("Save");
        $("#modal-form-title").html("teacher Save Form");
    });
