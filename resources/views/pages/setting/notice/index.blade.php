        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-large bg-light d-flex align-items-center">
                    <div class="flex">
                        <div class="card-subtitle text-muted">List of Notices</div>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-form-title">Notice</h5>
                ...
                <form action="#" method="post" enctype="multipart/form-data" id="entry_edit_form">
                    ...
                    <div class="was-validated">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <label class="text-label" for="email">Role:</label>
                                <div class="input-group input-group-merge">
            ...
            <div class="modal-body">
                <div class="row g-3 ">
                    <div class="col-md-6">
                        ...
                        <div id="notice_number" class="text-muted"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="me-1">Title:</div>
                        <div id="notice_title" class="text-muted"></div>
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        <div class="me-1">Description:</div>
                        <div id="notice_description" class="text-muted"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="me-1">Status:</div>
                        <div id="notice_status" class="text-muted"></div>
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        <div class="me-1">Role:</div>
                        <div id="notice_role" class="text-muted"></div>
                    </div>
                </div>
            </div> <!-- // END .modal-body -->
            <div class="modal-footer">
...
function saveForm(id) {
    var url = site_url + 'api/notice/save';
    var data = {
        '_token': '{{ csrf_token() }}',
        number: $('#number').val(),
        title: $('#title').val(),
    ...
    if (!(id === undefined)) {
        url = site_url + 'api/notice/update';
        data.id = id;
    }
    $.ajax({
        type: "POST",
...
function loadRecord(id) {
    $.ajax({
        ...
        success: (function(data) {
            $('#notice_number').text(data.number);
            $('#notice_title').text(data.title);
            $('#notice_status').text(data.notice_status);
            $('#notice_description').text(data.description);
            $('#notice_role').text(data.role);
...
function deleteRecord() {
    ...
    $.ajax({
        type: "POST",
        url: site_url + 'api/notice/delete',
        data: {
            id: deleteRecordID,
            '_token': '{{ csrf_token() }}'
        },
