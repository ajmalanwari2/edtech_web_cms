...
<body class="layout-default">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <label>Correct: <small> {{Session::get('wrongans')}}</small></label>
            <label>Correct: <small> {{Session::get('correctans')}} / {{Session::get('correctans') + Session::get('wrongans')}}</small></label>
            <br>
            <a href="{{ route('content.show', $chapter_id) }}" class="btn btn-danger float-left">Finish Quiz</a>
        </div>
