            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                        ...
                        <a class="btn btn-danger" href="{{ route('content.index') }}" style="margin-right: 5px;">Back</a>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-12 mb-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input id="q_image" name="q_image" type="file" style="display: none;"> -->
...
<div class="file_status"></div>
                            ...
                            <div class="form-row">
                                <div class="col-12 col-md-12 mb-12">
                                    <label class="text-label" for="answer">Choose Correct Answer from above given options:</label>
                                    <div class="input-group input-group-merge">
...
@section('scripts')
  ...
  function saveForm(id) {
            try {
                var url = site_url + 'api/course_quiz/save';
                ...
                if (!(id === undefined)) {
                    url = site_url + 'api/course_quiz/update';
        ...
        function loadRecord(type, id) {
            ...
            $.ajax({
                type: "POST",
                url: site_url + 'api/course_quiz/show',
                data: {
                    id: id,
                    '_token': '{{ csrf_token() }}'
                },
        ...
        serverSide: true,
            ajax: {
                url: site_url + 'api/course_quiz/list',
                type: 'POST',
                data: {
                    course_id: courseId,
                    '_token': '{{ csrf_token() }}'
