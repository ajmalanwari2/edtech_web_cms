...
@section('title')
<title>Library Audio</title>
@endsection
@section('content')
<div class="page__heading">
    <div class="container-fluid page__container">
        <h1 class="mb-0">Library Audios</h1>
    </div>
</div>
<div class="container-fluid page__container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-large bg-light d-flex align-items-center">
                    <div class="flex">
                        <div class="card-subtitle text-muted">List of Library Audios</div>
                    </div>
                ...
                <div class="card-body">
                    <table id="library_audio" class="display  table-bordered" style="width:100%">
                        <thead>
                            <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-form-title">Library Audio</h5>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div id="library_audio_number" class="text-muted"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="me-1">Subject Name:</div>
                        <div id="library_audio__subject_name" class="text-muted"></div>
                    </div>
                </div>
                <div class="row g-3 mt-2">
                <div class="col-md-6">
                        <div class="me-1">Description:</div>
                        <div id="library_audio_description" class="text-muted"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="me-1">Library Audio Status:</div>
                        <div id="library_audio_status" class="text-muted"></div>
                    </div>
                </div>
                <div class="row g-3 mt-2">
                <div class="col-md-6">
                        <div class="me-1">Language:</div>
                        <div id="library_audio_language" class="text-muted"></div>
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-md-12 table-responsive">
                        <table id="contentTable" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th colspan="3" class="title">Library Audio Contents</th>
                                </tr>
                                <tr>
                                    <th>Title</th>
                                    <th>Content</th>
...
var table = $('#library_audio').DataTable({
    dom: 'Bfrtip',
        lengthMenu: [
            [10, 25, 50, -1],
    ...
    serverSide: true,
    ajax: {
        url: site_url + 'api/library_audio/list',
        type: 'POST',
        data: {
            '_token': '{{ csrf_token() }}'
        }
    ...
    columns: [
        ...
        {
            data: 'library_audio_content_count'
        },
        {
            data: 'library_audio_status'
        },
        {
            data: 'language'
        },
...
function saveForm(id) {
    var url = site_url + 'api/library_audio/save';
    var data = {
        '_token': '{{ csrf_token() }}',
        number: $('#number').val(),
    ...
    if (!(id === undefined)) {
        url = site_url + 'api/library_audio/update';
        data.id = id;
    }
    $.ajax({
        type: "POST",
...
function loadRecord(id) {
    $.ajax({
        type: "POST",
        url: site_url + 'api/library_audio/show',
        data: {
            id: id,
            '_token': '{{ csrf_token() }}'
        },
        ...
        success: (function(data) {
            $('#library_audio_number').text(data.number);
            $('#library_audio__subject_name').text(data.subject_name);
            $('#library_audio_status').text(data.library_audio_status);
            $('#library_audio_description').text(data.description);
            $('#library_audio_language').text(data.language);
            ...
            $("#saveBTN").html("Update");
            $("#modal-form-title").html("Library Audio");
...
function deleteRecord() {
    ...
    $.ajax({
        type: "POST",
        url: site_url + 'api/library_audio/delete',
        data: {
            id: deleteRecordID,
            '_token': '{{ csrf_token() }}'
        },
