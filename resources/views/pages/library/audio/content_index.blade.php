...
@section('title')
    <title>Library Audio Content</title>
@endsection
@section('content')
    <div class="page__heading">
        <div class="container-fluid page__container">
            <h1 class="mb-0">Library Audio Content</h1>
        </div>
    </div>
    <div class="container-fluid page__container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                        <div class="flex">
                            <div class="card-subtitle text-muted">List of Library Audio Contents</div>
                        </div>
                        <a class="btn btn-danger" href="{{ route('library_audio.index') }}" style="margin-right: 5px;">Back</a>
                        ...
                        <table id="content_view" class="display  table-bordered" style="width:100%">
                            <thead>
                                ...
                                <th style="display:none">Updated at</th>
                                    <th>Library Audio Content Title</th>
                                    <th>Library Audio Content</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                        </table>
...
@section('modals')
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input id="title" type="text" required=""
                                            ...
                                            value="{{ old('title') }}">
                                        <input type="hidden" id="library_audio_id" name="library_audio_id" value="{{ $library_audio_id }}">
    ...
    <div id="modal-view" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-form-title"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-title">Library Audio Content</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div> <!-- // END .modal-header -->
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="me-1">Library Audio Content Title:</div>
                            <div id="library_audio_content_title" class="text-muted"></div>
                        </div>
                        <div class="col-md-6" id="file_view" style="display: none;">
                            <div class="me-1">Library Audio Content:</div>
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-md-6">
                            ...
                            <div id="library_audio_content_type" class="text-muted"></div>
                        </div>
                    </div>
                </div> <!-- // END .modal-body -->
                <div class="modal-footer">
...
<script type="text/javascript">
    ...
    function saveForm(id) {
        var url = site_url + 'api/library_audio_content/save';
        var formData = new FormData();
        formData.append('_token', '{{ csrf_token() }}');
        formData.append('title', $('#title').val());
        formData.append('library_audio_id', $('#library_audio_id').val());
        formData.append('file', $('#file')[0].files[0]);
      
        if (!(id === undefined)) {
            url = site_url + 'api/library_audio_content/update';
    ...
    function loadRecord(id) {
        $.ajax({
            type: "POST",
            url: site_url + 'api/library_audio_content/library-audio-content-show',
            data: {
                id: id,
                '_token': '{{ csrf_token() }}'
            },
    ...
    var libraryAudioId = {{ $library_audio_id }};
    ...
    serverSide: true,
        ajax: {
            ...
            url: site_url + 'api/library_audio_content/list',
            type: 'POST',
            data: {
    ...
    function deleteRecord() {
        ...
        $.ajax({
            type: "POST",
            url: site_url + 'api/library_audio_content/delete',
            data: {
                id: deleteRecordID,
                '_token': '{{ csrf_token() }}'
            },
