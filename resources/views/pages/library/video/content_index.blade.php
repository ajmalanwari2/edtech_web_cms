...
@section('title')
    <title>Library Video Content</title>
@endsection
@section('content')
    <div class="page__heading">
        <div class="container-fluid page__container">
            <h1 class="mb-0">Library Video Content</h1>
        </div>
    </div>
    <div class="container-fluid page__container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                        <div class="flex">
                            <div class="card-subtitle text-muted">List of Library Video Contents</div>
                        </div>
                        <a class="btn btn-danger" href="{{ route('library_video.index') }}" style="margin-right: 5px;">Back</a>
                        ...
                        <table id="content_view" class="display  table-bordered" style="width:100%">
                            <thead>
                                ...
                                <th style="display:none">Updated at</th>
                                    <th>Library Video Content Title</th>
                                    <th>Library Video Content</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                        </table>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-title">Library Video Content</h5>
                        ...
                        <div class="was-validated">
                            <div class="form-row">
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input id="title" type="text" required=""
                                            ...
                                            value="{{ old('title') }}">
                                        <input type="hidden" id="library_video_id" name="library_video_id" value="{{ $library_video_id }}">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="video" name="body"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="me-1">Library Video Content Title:</div>
                            <div id="library_video_content_title" class="text-muted"></div>
                        </div>
                        <div class="col-md-6" id="file_view" style="display: none;">
                            <div class="me-1">Library Video Content:</div>
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-md-6">
                            ...
                            <div id="library_video_content_type" class="text-muted"></div>
                        </div>
                    </div>
                </div> <!-- // END .modal-body -->
                <div class="modal-footer">
...
<script type="text/javascript">
    ...
    function saveForm(id) {
        var url = site_url + 'api/library_video_content/save';
        var formData = new FormData();
        formData.append('_token', '{{ csrf_token() }}');
        formData.append('title', $('#title').val());
        formData.append('library_video_id', $('#library_video_id').val());
        formData.append('body', $('#video').val());
      
        if (!(id === undefined)) {
            url = site_url + 'api/library_video_content/update';
    ...
    function loadRecord(id) {
        $.ajax({
            type: "POST",
            url: site_url + 'api/library_video_content/library-video-content-show',
            data: {
                id: id,
                '_token': '{{ csrf_token() }}'
            },
            ...
            success: (function(data) {
                $('#library_video_content').html(data.body);
                $('#library_video_content_title').text(data.title);
                $('#title').val(data.title);
                $('#video').val(data.body);
                $("#saveBTN").attr("onclick", "saveForm(" + data.id + ")");
                $("#saveBTN").html("Save");
                $("#modal-form-title").html("Library Video Content");
    ...
    var libraryVideoId = {{ $library_video_id }};
    ...
    serverSide: true,
        ajax: {
            ...
            url: site_url + 'api/library_video_content/list',
            type: 'POST',
            data: {
    ...
    function deleteRecord() {
        ...
        $.ajax({
            type: "POST",
            url: site_url + 'api/library_video_content/delete',
            data: {
                id: deleteRecordID,
                '_token': '{{ csrf_token() }}'
            },
