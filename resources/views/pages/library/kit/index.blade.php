...
@section('title')
<title>Library Kit</title>
@endsection
@section('content')
<div class="page__heading">
    <div class="container-fluid page__container">
        <h1 class="mb-0">Library Kits</h1>
    </div>
</div>
<div class="container-fluid page__container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-large bg-light d-flex align-items-center">
                    <div class="flex">
                        <div class="card-subtitle text-muted">List of Library Kits</div>
                    </div>
                ...
                <div class="card-body">
                    <table id="library_kit" class="display  table-bordered" style="width:100%">
                        <thead>
                            <tr>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <input id="name" type="text" required=""
                                        class="form-control form-control-prepended" placeholder="Kit Name"
                                        value="{{ old('name') }}">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <span class="fas fa-list-ol"></span>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div id="library_kit_number" class="text-muted"></div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-md-6">
                        ...
                        <div id="library_kit_description" class="text-muted"></div>
                    </div>
                    <div class="col-md-6">
                        <div class="me-1">Library Kit Status:</div>
                        <div id="library_kit_status" class="text-muted"></div>
                    </div>
                </div>
                <div class="row g-3 mt-2">
                <div class="col-md-6">
                        <div class="me-1">Language:</div>
                        <div id="library_kit_language" class="text-muted"></div>
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-md-12 table-responsive">
                        <table id="contentTable" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th colspan="3" class="title">Library Kit Contents</th>
                                </tr>
                                <tr>
                                    <th>Title</th>
                                    <th>Content</th>
...
var table = $('#library_kit').DataTable({
    dom: 'Bfrtip',
        lengthMenu: [
            [10, 25, 50, -1],
    ...
    serverSide: true,
    ajax: {
        url: site_url + 'api/library_kit/list',
        type: 'POST',
        data: {
            '_token': '{{ csrf_token() }}'
        }
    ...
    columns: [
        ...
        {
            data: 'library_kit_content_count'
        },
        {
            data: 'library_kit_status'
        },
        {
            data: 'language'
        },
...
function saveForm(id) {
    var url = site_url + 'api/library_kit/save';
    var data = {
        '_token': '{{ csrf_token() }}',
        number: $('#number').val(),
        name: $('#name').val(),
    ...
    if (!(id === undefined)) {
        url = site_url + 'api/library_kit/update';
        data.id = id;
    }
    $.ajax({
        type: "POST",
...
function loadRecord(id) {
    $.ajax({
        type: "POST",
        url: site_url + 'api/library_kit/show',
        data: {
            id: id,
            '_token': '{{ csrf_token() }}'
        },
        ...
        success: (function(data) {
            ...
            $("#saveBTN").html("Update");
            $("#modal-form-title").html("Library Kit");
...
function deleteRecord() {
    ...
    $.ajax({
        type: "POST",
        url: site_url + 'api/library_kit/delete',
        data: {
            id: deleteRecordID,
            '_token': '{{ csrf_token() }}'
        },
