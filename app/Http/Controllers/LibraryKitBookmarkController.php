...
use App\Models\LibraryKitBookmark;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use App\Models\User;
use App\Models\Student;
use DataTables;
class LibraryKitBookmarkController extends Controller
{
    /**
    ...
    public function update(Request $request)
    {
        ...
        $bookmark = LibraryKitBookmark::where('user_id', $user_id)
                            ->where('library_kit_id', $request->library_kit_id)
                            ->first();
        
        if (!$bookmark) {
            // If no bookmark exists, create a new one
            $bookmark = new LibraryKitBookmark();
            $bookmark->user_id = $user_id;
            $bookmark->library_kit_id = $request->library_kit_id;
        }
    ...
    FROM
        users AS u
        LEFT JOIN library_kit_bookmarks AS b ON u.id = b.user_id 
        LEFT JOIN library_kits AS la ON la.id = b.library_kit_id 
