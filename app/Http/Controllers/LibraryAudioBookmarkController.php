...
use App\Models\LibraryAudioBookmark;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use App\Models\User;
use App\Models\Student;
use DataTables;
class LibraryAudioBookmarkController extends Controller
{
    /**
    ...
    public function update(Request $request)
    {
        ...
        $bookmark = LibraryAudioBookmark::where('user_id', $user_id)
                            ->where('library_audio_id', $request->library_audio_id)
                            ->first();
        
        if (!$bookmark) {
            // If no bookmark exists, create a new one
            $bookmark = new LibraryAudioBookmark();
            $bookmark->user_id = $user_id;
            $bookmark->library_audio_id = $request->library_audio_id;
        }
    ...
    FROM
        users AS u
        LEFT JOIN library_audio_bookmarks AS b ON u.id = b.user_id 
        LEFT JOIN library_audios AS la ON la.id = b.library_audio_id
